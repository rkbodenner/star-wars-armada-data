[
    ...
    },
    {
        ...
        type: "Crew",
        text:
            "Your opponent may either reduce your speed by 1 or choose a new command on your top command dial. Then flip this card facedown.",
    ...
    },
    {
        ...
        type: "Ship",
        text:
            "When attacking a ship, before you roll your attack pool, remove 1 die of your choice.",
    ...
    },
    {
        ...
        type: "Crew",
        text:
            "Discard all of your command tokens.\nYou cannot have any command tokens.",
    ...
    },
    {
        ...
        type: "Ship",
        text:
            "When attacking a squadron, before you roll your attack pool, remove 1 die of your choice.",
    ...
    },
    {
        ...
        type: "Ship",
        text:
            "Your engineering value is reduced to half its value, rounded down.",
    ...
    },
    {
        ...
        type: "Ship",
        text:
            "Your hull zone with the most remaining shields loses all of its shields. If multiple hull zones are tied, choose between the tied hull zones. Then flip this card face down.",
    ...
    },
    {
        ...
        type: "Ship",
        text:
            "Your opponent may choose up to 2 of your hull zones. Each of the chosen hull zones loses 1 shield. Then flip this card facedown.",
    ...
    },
    {
        ...
        type: "Ship",
        text:
            "Deal 1 facedown damage card to your ship. Then flip this card facedown.",
    ...
    },
    {
        ...
        type: "Ship",
        text:
            "The yaw value for the last adjustable joint at your current speed is reduced by 1.",
